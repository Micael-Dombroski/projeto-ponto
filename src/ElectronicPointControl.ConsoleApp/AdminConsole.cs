...
namespace ElectronicPointControl.ConsoleApp
{
    public class AdminConsole
    {
        ...
        private EmployeeCRUD employees;
        private AdminCRUD admins;
        ...
        public void EmployeeList()
        {
            ...
            {
                Console.WriteLine($"{emp.CPF} | {emp.Name} | {emp.Registration} | {emp.Password} | {emp.WorkLoad.StartHour} - {emp.WorkLoad.EndHour}");
            }
        }
